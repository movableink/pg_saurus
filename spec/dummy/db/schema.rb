...
ActiveRecord::Schema.define(version: 20180108035548) do
  ...
  add_index "demography.cities", ["country_id"], name: "index_demography_cities_on_country_id", using: :btree
  ...
  add_index "demography.citizens", ["country_id", "user_id"], name: "index_demography_citizens_on_country_id_and_user_id", unique: true, where: "active", using: :btree
  ...
  add_index "pets", ["country_id"], name: "index_pets_on_country_id", using: :btree
  add_index "pets", ["lower(name)"], name: "index_pets_on_lower_name", using: :btree
  add_index "pets", ["to_tsvector('english'::regconfig, name)"], name: "index_pets_on_to_tsvector_name_gist", using: :gist
  add_index "pets", ["upper(color)"], name: "index_pets_on_upper_color", where: "(name IS NULL)", using: :btree
